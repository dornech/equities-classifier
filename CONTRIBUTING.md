...
Welcome to the contributor guide of Sector/industry classifier for equities.
...
If you experience bugs or general issues with Sector/industry classifier for equities, please have a look
...
You can help improve the documentation of Sector/industry classifier for equities by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/equities-classifier.git
   cd equities-classifier
   ```
