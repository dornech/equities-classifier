# Sector/industry classifier for equities

Package to retrieve sector/industry assignments based on a flexible connector architecture for different data sources
